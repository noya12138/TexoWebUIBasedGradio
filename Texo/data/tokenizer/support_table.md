...
|\Bra|$\Bra{\psi}$|`\Bra{\psi}`|
|\bra|$\bra{\psi}$|`\bra{\psi}`|
|\braket|$\braket{\phi\|\psi}$|<code>\braket{\phi&#124;\psi}</code>|
|\Braket|$\Braket{ ϕ \| \frac{∂^2}{∂ t^2} \| ψ }$| <code>\Braket{ ϕ &#124; \frac{∂^2}{∂ t^2} &#124; ψ }</code>|
...
|\set|$\set{x\|x<5}$|<code>\set{x&#124;x<5}</code> |
|\Set|$\Set{ x \| x<\frac 1 2 }$ | <code>\Set{ x &#124; x<\frac 1 2}</code> |
